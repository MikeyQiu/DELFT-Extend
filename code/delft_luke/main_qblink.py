...
from data import QBLINKDataset
...
def evaluate(data_loader, model):
    ...
    # file = open('total_list_luke_qblink_pruned.txt','w')
...
def parse_args():
    ...
    parser.add_argument("--train-file", type=str, default='data/qblink_train_graph.json')
    parser.add_argument("--dev-file", type=str, default='data/qblink_dev_graph.json')
    parser.add_argument('--test-file', type=str, default = 'data/qblink_test_graph_pruned.json')
    parser.add_argument('--save-model', type=str, default='experiments/qblink_delft_luke.pt')
    parser.add_argument('--load-model', type=str, default='experiments/qblink_delft_luke.pt')
    ...
    parser.add_argument('--log-file', type=str, default = 'experiments/qblink_luke.log')
...
if __name__ == "__main__":
    ...
    tokenizer = LukeTokenizer.from_pretrained("studio-ousia/luke-base")
    train_dataset = QBLINKDataset(train_graph, args, tokenizer, True)
    dev_dataset = QBLINKDataset(dev_graph, args, tokenizer, False)
