...
def parse_args():
    ...
    parser.add_argument("--train-file", type=str, default='../../data/trivia_train_graph.json')
    parser.add_argument("--dev-file", type=str, default='../../data/trivia_dev_graph.json')
    parser.add_argument('--test-file', type=str, default = '../../data/trivia_test_graph.json')
    parser.add_argument("--bert_model", default="bert-base-uncased", type=str)
    parser.add_argument('--save-model', type=str, default='../../experiments/trivia_delft_bert.pt')
    parser.add_argument('--load-model', type=str, default='../../experiments/trivia_delft_bert.pt')
