...
class LinkPrediction(nn.Module):
    ...
    def encode(self, *args, **kwargs): #encode entity, private method
...
class BertEmbeddingsLP(InductiveLinkPrediction):
    ...
    def _encode_entity(self, text_tok, text_mask):
        ...
        embs = self.encoder(text_tok, text_mask)[0][:, 0] #_encode entity with it's description
        embs = self.enc_linear(embs) #linear transformation
        return embs

#Base class for following 2 classes
